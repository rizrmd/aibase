...
const context = () =>
  ...
  "\n" +
  "**Parameters:**\n" +
  "- `description` (required when creating new): What the extension does\n" +
  ...
  "- Modifying a default extension uses it as the staging base; finalize writes a project version\n" +
